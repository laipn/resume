...
- Worked on: Google Borg (Kubernetes equivalent) [Node](https://kubernetes.io/docs/concepts/overview/components/#node-components), server platform and compute performance teams.
